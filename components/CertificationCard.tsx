...
export default function CertificationCard({ certification, index }: CertificationCardProps) {
  ...
  return (
    <motion.div
      ...
      className="flex items-center gap-3 border border-gray-200 dark:border-gray-800 rounded-2xl p-4 bg-white dark:bg-gray-900 mb-3 hover:shadow-lg transition-shadow"
    >
      <Award size={18} />
      <div>
