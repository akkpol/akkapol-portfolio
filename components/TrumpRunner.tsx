...
export default function TrumpRunner() {
  ...
  return (
    ...
    >
      ...
      {/* Character - using emoji for now, user can replace with PNG later */}
      <div
        className="absolute text-7xl transition-all duration-600"
        style={{
          left: '80px',
          bottom: isJumping ? '280px' : '120px',
        }}
      >
        🧡
      </div>
