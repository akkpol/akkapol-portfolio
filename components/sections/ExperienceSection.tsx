                ...
                <GlassCard className="p-6">
                  <div className="flex flex-wrap items-start justify-between gap-4">
                    <div>
                      ...
                      <h3 className="mt-1 font-display text-2xl font-semibold text-gray-900 dark:text-white">{exp.title}</h3>
                      <p className="text-accent-blue">{exp.company} · {exp.location}</p>
                    </div>
                    {/* Tech stack is not in the Experience type, removing it for now or we need to update type */}
                  </div>
