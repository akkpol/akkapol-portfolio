      ...
      <section id="contact" className="px-6 pb-24">
        ...
        <GlassCard className="mx-auto mt-8 max-w-4xl p-8">
          <div className="grid gap-6 md:grid-cols-3">
            ...
            <div className="space-y-2">
              ...
              <p className="flex items-center gap-2 text-text-primary">
                <Phone size={16} />
                {data.basics.phone} · Line: {data.basics.line}
              </p>
            </div>
            <div className="space-y-2">
          ...
          <div className="mt-6 flex flex-wrap justify-center gap-4">
            <PrimaryButton href={data.basics.portfolio || '#'}>View Portfolio</PrimaryButton>
            <SecondaryButton href={data.basics.socials.linkedin}>LinkedIn</SecondaryButton>
            <SecondaryButton href={data.basics.github || '#'}>GitHub</SecondaryButton>
          </div>
        </GlassCard>
      </section>

      <footer className="border-t border-gray-200 dark:border-white/5 bg-surface/60">
